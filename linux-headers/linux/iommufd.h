...
enum {
	...
	IOMMUFD_CMD_VDEVICE_TSM_GUEST_REQUEST = 0x95,
};
...
enum iommu_viommu_type {
	...
	IOMMU_VIOMMU_TYPE_AMD = 3, /* TODO: use */
};
...
#define SPDM_MEASUREMENTS_NONCE_LEN 32 /* Also defined in uapi/linux/tsm.h */
...
struct iommu_vdevice_tsm_guest_request {
	...
	__u32 rsp_len;
	__u32 req_len;
	__u8 measurements_nonce[SPDM_MEASUREMENTS_NONCE_LEN];
	__s32 fw_err;
} __attribute__((packed));
