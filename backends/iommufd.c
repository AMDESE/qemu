...
int iommufd_backend_tsm_bind(struct IOMMUFDVdev *vdev, int kvmfd)
{
    ...
    trace_iommufd_tsm_bind(fd, b.vdevice_id, b.kvmfd);
                                      ...
                                      int *fw_err)
{
    ...
    struct iommu_vdevice_tsm_guest_request gr = {
        ...
        .req_len = reqlen,
        .rsp_len = rsplen,
        .scope = IOMMU_VDEVICE_TSM_SCOPE_REQ_INFO,
    };
    ...
    if (rsplen == 0) {
        gr.scope = IOMMU_VDEVICE_TSM_SCOPE_REQ_STATE_CHANGE;
    }
    ...
    *fw_err = gr.fw_err;
    ...
    trace_iommufd_tsm_guest_request(fd, gr.vdevice_id, gr.scope, gr.fw_err);
