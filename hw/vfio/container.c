...
static VFIODevice *container_dev_iter_next(VFIOContainer *bcontainer,
                                           VFIODevice *curr)
{
    VFIOGroup *group;
 ...
 */
static int vfio_dma_unmap(VFIOContainer *bcontainer, hwaddr iova,
...
static int vfio_set_dirty_page_tracking(VFIOContainer *bcontainer, bool start)
{
    VFIOLegacyContainer *container = container_of(bcontainer,
                                                  VFIOLegacyContainer,
                                                  bcontainer);
...
static int vfio_query_dirty_bitmap(VFIOContainer *bcontainer, VFIOBitmap *vbmap,
